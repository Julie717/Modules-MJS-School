...
public class SqlQuery {
    ...
    public static final String SELECT_GIFT_CERTIFICATE_BY_ID = "SELECT id_gift_certificate, " +
            "name_gift_certificate, description, price, duration, create_date, last_update_date " +
            "FROM gift_certificate " +
            "WHERE (id_gift_certificate = ?)";
    public static final String SELECT_GIFT_CERTIFICATE_BY_NAME = "SELECT id_gift_certificate, " +
            "name_gift_certificate, description, price, duration, create_date, last_update_date " +
            "FROM gift_certificate " +
            "WHERE (name_gift_certificate = ?)";
    public static final String SELECT_ALL_GIFT_CERTIFICATES = "SELECT id_gift_certificate, name_gift_certificate, " +
            "description, price, duration, create_date, last_update_date " +
            "FROM gift_certificate";
    public static final String ADD_GIFT_CERTIFICATE = "INSERT INTO gift_certificate (name_gift_certificate, " +
    ...
    public static final String SELECT_GIFT_CERTIFICATE_BY_ID_WITH_TAGS = "SELECT gift_certificate.id_gift_certificate, " +
            "name_gift_certificate, description, price, duration, create_date, last_update_date, " +
            "tag.id_tag, name_tag " +
            "FROM gift_certificate LEFT JOIN gift_certificate_tag " +
